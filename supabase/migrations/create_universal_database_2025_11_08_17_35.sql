...
VALUES ('u1a2b3c4-d5e6-7890-abcd-ef1234567890', 'a5b7bab7-74c0-47f3-a0df-c5de4b071ce4', 'bybit', 'SUPER', 'USDT', 10, 11, 1, 1, 0.4, 0.5, NOW(), NOW());

-- Подписка для пользователя
INSERT INTO subscriptions (id, user_email, plan_name, expires_at, is_active, created_at, updated_at) 
VALUES ('u2a3b4c5-d6e7-8901-bcde-f12345678901', 'cloudkroter@gmail.com', 'pro', '2026-11-07T12:00:00+00:00', true, NOW(), NOW());
