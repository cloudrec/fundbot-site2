...
async function placeOrderWithTPSL(apiKey: any, settings: any) {
  try {
    ...
    if (apiKey.exchange === 'binance') {
      console.log('🔥 Processing Binance order with TP/SL - ВОССТАНОВЛЕННАЯ РАБОЧАЯ ВЕРСИЯ');
      ...
      return {
        ...
        binance_version: 'RESTORED_WORKING'
      };
    }
