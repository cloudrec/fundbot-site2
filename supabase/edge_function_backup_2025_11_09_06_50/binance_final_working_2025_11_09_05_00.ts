...
serve(async (req) => {
  ...
  try {
    ...
    console.log('🟡 BINANCE FINAL: Starting action:', action);
    ...
    console.log('🟡 BINANCE FINAL: Keys loaded, settings:', !!settings);
    ...
    console.error('❌ BINANCE FINAL Error:', error.message);
    return new Response(
...
async function handleGetBalance(apiKeys: any) {
  console.log('🟡 BINANCE FINAL: Getting balance');
...
// Размещение ордера с TP/SL - ПРОВЕРЕННАЯ ЛОГИКА
async function handlePlaceOrderWithTPSL(apiKeys: any, settings: any) {
  console.log('🟡 BINANCE FINAL: Placing order with TP/SL');
...
async function placeOrder(apiKeys: any, orderParams: any) {
  ...
  const data = await response.json();
  console.log('🟡 BINANCE FINAL: Order response:', data);
...
async function handleClosePositions(apiKeys: any) {
  console.log('🟡 BINANCE FINAL: Closing positions');
...
async function handleCancelOrders(apiKeys: any) {
  console.log('🟡 BINANCE FINAL: Canceling orders');
