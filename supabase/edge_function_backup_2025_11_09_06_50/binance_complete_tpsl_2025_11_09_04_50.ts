...
serve(async (req) => {
  ...
  try {
    ...
    console.log('🟡 BINANCE COMPLETE: Starting action:', action);
    ...
    console.log('🟡 BINANCE COMPLETE: Keys loaded, settings:', !!settings);
...
async function handleGetBalance(apiKeys: any) {
  console.log('🟡 BINANCE COMPLETE: Getting balance');
...
async function handlePlaceOrderWithTPSL(apiKeys: any, settings: any) {
  console.log('🟡 BINANCE COMPLETE: Placing order with TP/SL');
  ...
  const quantity = '0.001'; // Фиксированное количество для тестирования
...
async function handleClosePositions(apiKeys: any) {
  console.log('🟡 BINANCE COMPLETE: Closing positions');
...
async function handleCancelOrders(apiKeys: any) {
  console.log('🟡 BINANCE COMPLETE: Canceling orders');
