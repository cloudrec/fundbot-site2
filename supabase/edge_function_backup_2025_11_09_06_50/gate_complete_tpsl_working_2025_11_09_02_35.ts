...
serve(async (req) => {
  ...
  try {
    ...
    console.log('🎯 GATE.IO COMPLETE TP/SL: Starting action:', action);
    ...
    console.log('🎯 GATE.IO COMPLETE TP/SL: Keys loaded, settings:', !!settings);
    ...
    console.error('❌ GATE.IO COMPLETE TP/SL Error:', error.message);
    return new Response(
...
async function handleGetBalance(apiKeys: any) {
  console.log('🎯 GATE.IO COMPLETE TP/SL: Getting balance');
...
async function handlePlaceOrderWithTPSL(apiKeys: any, settings: any) {
  console.log('🎯 GATE.IO COMPLETE TP/SL: Placing order with TP/SL');
  
  if (!settings) {
    console.log('❌ GATE.IO COMPLETE TP/SL: No settings found');
    return new Response(
      JSON.stringify({
        success: false,
  ...
  console.log('🎯 GATE.IO COMPLETE TP/SL: Contract:', contract);
  ...
  console.log('🎯 GATE.IO COMPLETE TP/SL: Order params:', {
    contract,
    size,
    currentPrice,
    orderAmount,
...
async function placeOrder(apiKeys: any, orderData: any) {
  ...
  console.log('🎯 GATE.IO COMPLETE TP/SL: Placing order:', orderData);
  ...
  const responseData = await response.json();
  console.log('🎯 GATE.IO COMPLETE TP/SL: Order response:', responseData);
...
async function handleGetPositions(apiKeys: any) {
  console.log('🎯 GATE.IO COMPLETE TP/SL: Getting positions');
  ...
  const responseData = await response.json();
  console.log('🎯 GATE.IO COMPLETE TP/SL: Positions response:', responseData);
...
async function handleCancelAllOrders(apiKeys: any) {
  console.log('🎯 GATE.IO COMPLETE TP/SL: Cancelling all orders');
  ...
  const responseData = await response.json();
  console.log('🎯 GATE.IO COMPLETE TP/SL: Cancel orders response:', responseData);
...
async function handleCloseAllPositions(apiKeys: any) {
  console.log('🎯 GATE.IO COMPLETE TP/SL: Closing all positions with reduce_only');
  ...
  console.log('🎯 GATE.IO COMPLETE TP/SL: Found positions:', allPositions.length, 'open:', openPositions.length);
  ...
  for (const position of openPositions) {
    try {
      ...
      console.log(`🎯 GATE.IO COMPLETE TP/SL: Closing position ${position.contract}, size: ${positionSize} -> ${closeSize}`);
      ...
      console.log('🎯 GATE.IO COMPLETE TP/SL: Placing reduce_only order:', closeOrderData);
      ...
      const responseData = await response.json();
      console.log('🎯 GATE.IO COMPLETE TP/SL: Close order response:', responseData);
