...
async function placeOrderWithTPSL(apiKey: any, settings: any) {
  try {
    ...
    if (apiKey.exchange === 'binance') {
      ...
      console.log('🔥 Waiting 3 seconds before placing TP/SL orders...');
      await delay(3000);
    ...
    // Для Bybit возвращаем демо результат чтобы не сломать
    return {
